...
Original file is located at
    https://colab.research.google.com/drive/1cEpznm26E3lJxzgolUN4F6Z7UiOI623e
"""
...
data_canada_interpolated.sort_index()

# What type of Apple

Apple_type = "Envi" #Change here
...
data_canada_interpolated = data_canada_interpolated.drop(data_canada_interpolated.index[0])
print(data_canada_interpolated.head())
# Separate data set into a training and test set
train = data_canada_interpolated[:-156]
test = data_canada_interpolated[-156:]  # Exclude the last row
